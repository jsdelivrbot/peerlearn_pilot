...
$(document).ready(function () {
  document.getElementById("workerid").innerHTML = gup("workerId");
  document.getElementById("dynamic_url").href = "localhost:8000/endpoint?workerId=" + gup("workerId");
  console.log("WorkerId is: " + gup("workerId"));
